...
class SalleController extends Controller{
    ...
    public function voirAction(){
        return $this->render('@SalleTp/Salle/voir.html.twig',
                      array('numero' => $numero));
    }
    ...
    public function ajouter2Action(Request $request){
        ...
        $form = $this->createForm(SalleType::class, $salle,
                array('action' => $this->generateUrl('salle_tp_ajouter2')));
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            ->add('infoAjout',
                'nouvelle salle ajouter: '.$salle->__toString());
            //return $this->redirectToRoute('salle_tp_accueil');
    ...
    public function modifierAction($id){
        ...
        if(! $salle=$entityManager->getRepository('SalleTpBundle:Salle')->find($id))
            throw $this->createNotFoundException('Salle[id='.$id.'] inexistante');
            $form =$this->createForm(SalleType::class, $salle,
                array('action'=> $this->generateUrl('salle_tp_modifier_suite',
                    array('id' => $salle->getId()))));
            $form->add('submit', SubmitType::class, array('label' => 'modifier'));
            return $this->render('@SalleTp/Salle/modifier.html.twig',
    ...
    public function modifierSuiteAction(Request $request,$id){
        ...
        return $this->render('@SalleTp/Salle/modifier.html.twig',
            array('monFormulaire' => $form->createVieaw()));   
    }
